...
public class ProductDAO {
	...
	public ProductVO selectOneProductByPronum(String pronum) {
		...
		try {
			...
			if(rs.next()) {
				...
				vo.setCategory(rs.getString("category"));
				vo.setProname(rs.getString("proname"));
				vo.setProimgSmall("product\\images\\"+rs.getString("proimg_s"));
				vo.setProimgBig("product\\images\\"+rs.getString("proimg_b"));
				vo.setBrand(rs.getString("brand"));
				vo.setPronum(rs.getInt("pronum"));
				vo.setPrice(rs.getInt("price"));
				vo.setStock(rs.getInt("stock"));
	...
	public void insertProduct(ProductVO pVo) {
		String sql = "insert into HOSINSA_PRODUCT(category,proname,PROIMG_B,brand,pronum,price,stock)"
				+ "VALUES(?,?,?,?,?,?,?)";
 		Connection conn = null;
		PreparedStatement pstmt = null;
		...
		try {
			...
			pstmt.setString(3, pVo.getProimgBig());
			pstmt.setString(4, pVo.getBrand());
			pstmt.setInt(5, pVo.getPronum());
	...
	public void updateProviewCount(String proname) {
		String sql = "UPDATE HOSINSA_PRODUCT set PROVIEW= PROVIEW+1 WHERE PRONAME=?";
