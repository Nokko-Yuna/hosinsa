...
//				System.out.println(img_shoes.size());
				...
				try {
					for(int j=0; j<img_pants.size(); j++) {
						...
						File fileSmall = new File("C:\\Works2\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp1\\wtpwebapps\\Hosinsa\\images\\pants\\small_"+pNumber+".jpg");
						File fileBig = new File("C:\\Works2\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp1\\wtpwebapps\\Hosinsa\\images\\pants\\big_"+pNumber+".jpg");			
						...
						proimgSmall = "pants\\small_"+pNumber+".jpg";
						proimgBig = "pants\\big_"+pNumber+".jpg";
