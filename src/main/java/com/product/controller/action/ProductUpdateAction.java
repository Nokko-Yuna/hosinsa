...
public class ProductUpdateAction implements HosinsaAction {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		vo.setProimgSmall(request.getParameter("category")+"\\small_"+request.getParameter("proimgSmall"));
		vo.setProimgBig(request.getParameter("category")+"\\big_"+request.getParameter("proimgBig"));
